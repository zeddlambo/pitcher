...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { cid: @case.cid, issue: @case.issue, name: @case.name, points: @case.points, security: @case.security }
    end
  ...
  test "should update case" do
    patch :update, id: @case, case: { cid: @case.cid, issue: @case.issue, name: @case.name, points: @case.points, security: @case.security }
    assert_redirected_to case_path(assigns(:case))
  end
